...
public enum LotteryIds {
    ...
    xb_q8_2(44,"xb_q8",LotteryType.Q8.code(),2,"加拿大西部快乐8双面彩"),
    ...
    bc_ssc_az1(119, "bc_ssc_az", LotteryType.SSC.code(), 1, "秒速3分彩"),
    bc_ssc_az2(120, "bc_ssc_az", LotteryType.SSC.code(), 2, "秒速3分彩双面彩");
