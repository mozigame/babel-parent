...
public class MatrixToImageWriter {
    ...
    public static void createRqCode(String textOrUrl, String logoPath, int width, int height, OutputStream toStream)
        ...
        if(logoPath != null) {
        	applyLogo(image, logoPath);//应用LOGO
        }
    ...
    private static void applyLogo(BufferedImage image, String logoPath) throws IOException {

        Graphics2D gs = image.createGraphics();

//        ClassPathResource resource = new ClassPathResource(logoPath);//logo图片
        // 载入logo
