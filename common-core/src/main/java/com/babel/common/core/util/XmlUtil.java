...
public class XmlUtil {
	...
	public static String loadSpringXml(String fileName, String beanId, String propertyName) {
		String value=null;
		...
		try {
			String xmlStr=new String(FileUtil.readAsByteArray(is));
	        ...
	        for(Element e:children){
	        	if(beanId.equals(e.attributeValue("id"))){
	        		List<Element> childs=e.elements();
	        		for(Element child:childs){
	        			if(propertyName.equals(child.attributeValue("name"))){
    ...
    public static Object mapToBean(Map<String, Object> map, Class clazz) throws Exception {  
        ...
        if(map != null && map.size() > 0) {  
            for(Map.Entry<String, Object> entry : map.entrySet()) {  
                ...
                if(field==null){
                	System.err.println("propertyName="+propertyName+" not found");
                	continue;
                }
